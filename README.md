...
The code comes with the peer-reviewed software note [ACHR.cu: GPU-accelerated sampling of metabolic network.](http://joss.theoj.org/papers/10.21105/joss.01363).
